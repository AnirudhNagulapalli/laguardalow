<?php get_header(); ?>
<div class="row-fluid slider-wrapper theme-laguardalowSlider singleProjectSlider">
...
<div class="row-fluid" id="wrapper">
	...
	<div class="relatedProjectsContent">
		...
		<div class="container relatedProjectsTiles">
		  <div class="row-fluid" id="row1" style="height: 190px; margin-bottom: 10px;">
		    <div class="col-md-6" style="border: 1px solid; height: 100%; width: 48%; padding: 10px; text-align: center; vertical-align: middle; margin-right: 10px;">1st Image</div>
		    <div class="col-md-6" style="border: 1px solid; height: 100%; width: 48%; padding: 10px; text-align: center; vertical-align: middle; margin-right: 10px;">2nd Image</div>
		  </div>
		  <div class="row-fluid" id="row2" style="height: 190px; margin-bottom: 10px;">
		    <div class="col-md-6" style="border: 1px solid; height: 100%; width: 48%; padding: 10px; text-align: center; vertical-align: middle; margin-right: 10px;">3rd Image</div>
		    <div class="col-md-6" style="border: 1px solid; height: 100%; width: 48%; padding: 10px; text-align: center; vertical-align: middle; margin-right: 10px;">4th Image</div>
		  </div>
		</div>
	</div>
	<div style="clear:both;"></div> 
